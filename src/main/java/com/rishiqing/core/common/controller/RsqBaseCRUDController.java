package com.rishiqing.core.common.controller;
...
public abstract class RsqBaseCRUDController<Entity extends AbstractEntity<ID>, ID extends Serializable>
		extends RsqBaseBeanController<Entity> {
	...
	private void ajaxList(Queryable queryable, PropertyPreFilterable propertyPreFilterable, HttpServletRequest request,
		...
		logger.debug("====ajaxList 方法执行start");
