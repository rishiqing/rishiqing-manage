...
/**
 * @author rishiqing
 * @date 2018年9月18日09:51:19
 * @version V 1.0
 */
public class RsqBaseController {
	/**
	 * 日志对象
	 */
	...
	protected String defaultViewPrefix() {
		...
		if (requestMapping != null && requestMapping.value().length > 0) {
			...
			// 替换${admin.url.prefix}
			currentViewPrefix = currentViewPrefix.replace("${admin.url.prefix}", "rishiqing");
		}
